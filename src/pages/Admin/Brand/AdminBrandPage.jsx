...
import { getAllBrand, deleteBrand } from "../../../Redux/ActionCreators/BrandActionCreators"
import { useDispatch, useSelector } from 'react-redux'

export default function AdminBrandPage() {

  const BrandStateData = useSelector(
                ...
                <tbody>
                  ...
                  {BrandStateData.map(val => (
                    <tr key={val.name} className="text-center">
                      ...
                      <td>
                        <Link
                          to={`/admin/brand/update/${val.name}`}
