...
import { getAllSubCategory, deleteSubCategory } from "../../../Redux/ActionCreators/SubCategoryActionCreators"
...
export default function AdminSubCategoryPage() {
  ...
  const handleDelete = (name) => {
    if (window.confirm("Are you sure you want to delete?")) {
      dispatch(deleteSubCategory({ id: name }))
    }
  }
                ...
                <tbody>
                  ...
                  {SubCategoryStateData.map(val => (
                    <tr key={val.name} className="text-center">
                      ...
                      <td>
                        <Link
                          to={`/admin/sub-cat/update/${val.name}`}
