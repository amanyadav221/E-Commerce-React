...
import { CREATE_CONTACT_US, CREATE_CONTACT_US_RED, CREATE_NEWSLETTER, CREATE_NEWSLETTER_RED, DELETE_CONTACT_US, DELETE_CONTACT_US_RED, DELETE_NEWSLETTER, DELETE_NEWSLETTER_RED, GET_ALL_CONTACT_US, GET_ALL_CONTACT_US_RED, GET_ALL_NEWSLETTER, GET_ALL_NEWSLETTER_RED, UPDATE_CONTACT_US, UPDATE_CONTACT_US_RED, UPDATE_NEWSLETTER, UPDATE_NEWSLETTER_RED } from "../Constrants";
import { createContactUsIndex, createNewsletterIndex, deleteContactUsIndex, deleteNewsletterIndex, getAllContactUsIndex, getAllNewsletterIndex, updateContactUsIndex, updateNewsletterIndex } from "./Services/NewsletterIndex";
...
function* deleteContactUsSage(action) {
    let res = yield call(deleteContactUsIndex, "conatct-us/del", action.payload)
    yield put({
