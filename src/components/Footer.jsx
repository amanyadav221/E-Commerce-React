...
export default function Footer() {
  ...
  return (
    <footer className="footer bg-dark text-light mt-5 pt-5 pb-4" id="footer">
      <div className="container">
        <div className="row gy-4 text-light">
          ...
          <div className="col-12 col-md-6 col-lg-3">
            <NavLink to="/" className="text-white text-decoration-none d-inline-block mb-3">
              <i className="fs-2 fas fa-copyright text-light me-2"></i>
              <span className="fs-4 fw-bolder">{setting?.siteName ? setting.siteName : (import.meta.env.VITE_APP_SITE_NAME || "E-Mart")}</span>
            </NavLink>
            <div className="footer-contact fs-6">
              <p className="mb-2">
                ...
                <Link className='text-light text-decoration-none' to={import.meta.env.VITE_APP_MAP2 || "#"} target='_blank'>
                  {setting?.addressOne ? setting.addressOne : (import.meta.env.VITE_APP_ADDRESS1 || "Main Street")}
                  {setting?.addressTwo ? `, ${setting.addressTwo}` : ""}
                </Link>
              </p>
              <p className="mb-2">
                <i className='bi bi-phone me-2 text-warning' />
                <Link className='text-light text-decoration-none' to={`tel:${setting?.phone ? setting.phone : import.meta.env.VITE_APP_PHONE}`}>
                  {setting?.phone ? setting.phone : (import.meta.env.VITE_APP_PHONE || "+91 9999999999")}
                </Link>
              </p>
              <p className="mb-2">
                <i className='bi bi-envelope me-2 text-warning' />
                <Link className='text-light text-decoration-none' to={`mailto:${setting?.email ? setting.email : import.meta.env.VITE_APP_EMAIL}`}>
                  {setting?.email ? setting.email : (import.meta.env.VITE_APP_EMAIL || "info@emart.com")}
                </Link>
              </p>
              <p className="mb-3">
                ...
                <Link className='text-light text-decoration-none' to={`https://wa.me/${setting?.whatsapp ? setting.whatsapp : import.meta.env.VITE_APP_WHATSAPP}`} target='_blank'>
                  {setting?.whatsapp ? setting.whatsapp : (import.meta.env.VITE_APP_WHATSAPP || "+91 9999999999")}
                </Link>
              </p>
          ...
          <div className="col-12 col-md-6 col-lg-3 footer-links">
            <h4 className='text-white mb-3 fs-5 border-bottom pb-2 d-inline-block border-warning'>Useful Links</h4>
          ...
          <div className="col-12 col-md-6 col-lg-3 footer-links">
            <h4 className='text-white mb-3 fs-5 border-bottom pb-2 d-inline-block border-warning'>Our Services</h4>
            <ul className="list-unstyled">
          ...
          <div className="col-12 col-md-6 col-lg-3 footer-newsletter">
            <h4 className='text-white mb-3 fs-5 border-bottom pb-2 d-inline-block border-warning'>Our Newsletter</h4>
            ...
            <form onSubmit={postData}>
              <div className="input-group mb-3">
                ...
                <button className="btn btn-warning fw-bold" type="submit">Subscribe</button>
              </div>
            </form>
        ...
        <div className="row align-items-center">
          <div className="col-md-6 text-center text-md-start mb-2 mb-md-0 small">
            &copy; {new Date().getFullYear()} <strong className="text-white">{setting?.siteName ? setting.siteName : "E-Mart"}</strong>. All Rights Reserved.
          </div>
          <div className="col-md-6 text-center text-md-end small">
            Designed & Developed for E-Commerce
          </div>
        </div>
